...
MODIFIER_KEY_BITMASKS =  {
    ecodes.KEY_LEFTCTRL:   0b10000000,
    ecodes.KEY_LEFTSHIFT:  0b01000000,
    ecodes.KEY_LEFTALT:    0b00100000,
    ecodes.KEY_LEFTMETA:   0b00010000,
    ecodes.KEY_RIGHTCTRL:  0b00001000,
    ecodes.KEY_RIGHTSHIFT: 0b00000100,
    ecodes.KEY_RIGHTALT:   0b00000010,
    ecodes.KEY_RIGHTMETA:  0b00000001,
}
